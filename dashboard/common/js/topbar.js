...
(function() {
    ...
    window.PMS_Notifications = [
        ...
        { type: 'system', time: { ko: '30분 전', en: '30 min ago' }, title: { ko: '우수 고객 승급', en: 'VIP Upgrade' }, desc: { ko: 'Tran Linh 고객님의 등급이 골드에서 우수 고객으로 승급되었습니다.', en: 'Tran Linh was upgraded from Gold to VIP.' }, icon: 'fa-star', urgent: true },
