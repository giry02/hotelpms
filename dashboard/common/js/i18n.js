...
const PAGE_TITLE_MAP = {
    ...
    'Booking List':      { ko: '예약 관리',        en: 'Reservation Management' },
...
function getExactKoEnFallbackMap() {
    return {
        ...
        '건물/구역 Actions': 'Building / Area Actions',
        ...
        '본사(Super Admin) 시스템 공지': 'Super Admin System Notices',
        '시스템 점검': 'Maintenance',
...
Object.assign(window.translations.ko, {
    "Room Occupancy (OCC)": "객실 점유율 (OCC)",
    "Average Daily Rate (ADR)": "평균 객실 단가 (ADR)",
    "Revenue per Available Room (RevPAR)": "객실당 수익 (RevPAR)",
    ...
    "Target ad banner area · Region: Vietnam / Ho Chi Minh · CPM: $2.50": "타겟 광고 배너 영역 · 지역: Vietnam / Ho Chi Minh · CPM: $2.50",
    ...
    "Aroma therapy 90 min": "아로마 테라피 90분 코스",
    "Dry-cleaning shirt × 3": "드라이클리닝 셔츠 × 3",
    "Golf (External)": "골프(외부)",
