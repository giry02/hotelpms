...
function getExactKoEnFallbackMap() {
    return {
        ...
        'Samsung Tech Conference 2026 정산 검증': 'Samsung Tech Conference 2026 Settlement Demo',
        ...
        '정산 검증 Folio 생성': 'Settlement demo folio created',
...
function translateKoreanPattern(text) {
    ...
    Object.assign(cleanupMap, {
        ...
        'Stays객 교통비 지원 Cash 전달. 통화별 봉투 번호와 영수증을 인수인계 Memo에 기록.': 'Guest transport cash support handed over. Record envelope numbers and receipts by currency in the handover memo.',
        ...
        'Stays객 명단 변경': 'Guest List Changed',
        '동반 Stays객': 'Companion Guest',
        ...
        '체크아웃': 'Check-out',
        'Guest 명단 변경': 'Guest List Changed',
