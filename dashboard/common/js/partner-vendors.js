(function(){
  ...
  const seedVendors = [
    ...
    },
    {
      ...
      detailContentHtml:{
        ko:'<h4>제휴 검토 요약</h4><p>단체 고객과 VIP 투숙객의 골프 문의가 있을 때 프런트에서 바로 업체 연락처와 적용 조건을 확인하기 위한 광고입니다.</p><h4>계약 전 확인사항</h4><ul><li>주중/주말 그린피 기준과 카트 포함 여부</li><li>티타임 확정 방식, 우천 취소 기준, 취소 수수료</li><li>호텔 수수료율과 월말 정산 방식</li><li>바우처 출력에 들어갈 업체 주소, 연락처, 코스명</li></ul><h4>대표 상품 예시</h4><p>18홀 그린피 ₱450, 카트 이용권 ₱70, 클럽 대여 ₱60</p>',
        en:'<h4>Partnership review summary</h4><p>This ad helps front desk staff check vendor contact and terms when group or VIP guests ask about golf rounds.</p><h4>Before signing</h4><ul><li>Weekday/weekend green fee and cart inclusion</li><li>Tee-time confirmation, rain cancellation, and cancellation fee rules</li><li>Hotel commission rate and month-end settlement</li><li>Vendor address, contact, and course name for voucher output</li></ul><h4>Sample offers</h4><p>18-hole green fee ₱450, cart pass ₱70, club rental ₱60</p>'
      },
    ...
    },
    {
      ...
      internalNote:'계약 전 검토용 광고입니다.',
      detailContentHtml:{
        ko:'<h4>광고 제안</h4><p>평일 오전 조조 라운드를 원하는 투숙객이 있을 때 호텔 담당자가 스카이72와 직접 연락해 티타임 가능 여부를 확인하는 제휴 검토용 상세입니다.</p><h4>계약 후 사용 흐름</h4><ol><li>호텔 담당자가 이메일 또는 전화로 제휴 조건을 확인합니다.</li><li>계약이 확정되면 골프장 업체와 판매 항목을 부가서비스 관리에 등록합니다.</li><li>예약 또는 투숙 중 부가서비스 등록 화면에서 실제 이용 건으로 연결합니다.</li></ol><h4>호텔 확인사항</h4><p>조조 라운드 제공 시간, 카트비 포함 여부, 취소 마감 시간, 바우처 출력 필드를 먼저 확인해야 합니다.</p>',
        en:'<h4>Ad offer</h4><p>This detail is for hotel staff to contact Sky72 directly and verify tee-time availability for guests who want weekday early rounds.</p><h4>After contract workflow</h4><ol><li>Hotel staff confirm terms by phone or email.</li><li>After signing, the vendor and sellable items are registered in ancillary management.</li><li>Reservations or in-house guests can then be linked to real ancillary orders.</li></ol><h4>Hotel checklist</h4><p>Confirm early-round hours, cart fee inclusion, cancellation deadline, and voucher fields first.</p>'
      },
