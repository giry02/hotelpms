...
// 1. Add IDs to newGroupModal inputs
...
function saveGroup() {
    ...
    const sales = document.getElementById('ngSales').value.split(' ')[0]; // Extract name
...
console.log('Patched groups.html');
